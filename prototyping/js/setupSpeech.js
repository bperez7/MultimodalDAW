...
/*****************************************************************/
//import {processSpeech} from 'script.js';
...
recognition.onresult = function(event) {
    ...
    var speechTextBox = document.getElementById("speechTextBox");

          if (hasFinal)
              speechTextBox.innerHTML = "SPEECH DEBUG: ready";
          else
              speechTextBox.innerHTML = "SPEECH DEBUG:" + transcript;
